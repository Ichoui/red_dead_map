...
icons.note_marker = L.icon({iconUrl: '../files/images/icons/note_marker.png', iconSize: [23, 28]});
...
icons.innkeep = L.icon({iconUrl: '../files/images/icons/tavern.png', iconSize: [26, 30]});
...
icons.shopkeeper = L.icon({iconUrl: '../files/images/icons/merchant.png', iconSize: [21, 30]});
icons.signalfire = L.icon({iconUrl: '../files/images/icons/signalfire.png', iconSize: [17, 34]});
icons.signpost = L.icon({iconUrl: '../files/images/icons/fasttravel.png', iconSize: [27, 34]});
...
icons.contracts = L.icon({iconUrl: '../files/images/icons/tempcontract.png', iconSize: [18, 29]});
icons.vineyardinfestation = L.icon({iconUrl: '../files/images/icons/vineyardinfestation.png', iconSize: [28, 32]});
icons.vintnercontract = L.icon({iconUrl: '../files/images/icons/vintnercontract.png', iconSize: [23, 34]});
